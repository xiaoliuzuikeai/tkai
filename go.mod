...
require (
	...
	github.com/cloudwego/eino-ext/components/indexer/redis v0.0.0-20260813030315-32635d4ae67d
	github.com/cloudwego/eino-ext/components/model/ollama v0.1.9
	github.com/cloudwego/eino-ext/components/model/openai v0.1.13
	github.com/cloudwego/eino-ext/components/retriever/redis v0.0.0-20260813030315-32635d4ae67d
	...
	golang.org/x/crypto v0.55.0 // [第一阶段优化-认证] bcrypt 密码哈希
